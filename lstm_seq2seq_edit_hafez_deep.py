...
epochs = 1  # Number of epochs to train for. # last time I try it!!!
...
encoder_input_data_test = np.zeros(
    (1, max_encoder_seq_length+1, num_encoder_tokens),
    dtype='float32')
...
new_hafez_poem = './new_hafez_poem_' + dt + '.txt'    
